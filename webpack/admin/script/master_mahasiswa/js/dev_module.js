// new module master_mahasiswa

import {fetchDataAndRender, loadSelectOptions} from './ajax_module.js';
...
function buildStructure() {
                    ...
                    <h5 class="card-title m-0">
                        <div class="d-flex align-content-center flex-wrap">
                            <button type="button" class="btn btn-primary btn-sm m-1" data-toggle="modal"
                                data-target="#staticBackdrop-add" onclick="resetModalAdd_mahasiswa()">
    ...
    loadSelectOptions(url, target_select);
...
export function buildUrl(page, keyword_filter, gender_filter, image_filter, provinsi_filter, kabupaten_filter, kecamatan_filter, desa_filter, matkul_filter) {
...
export function renderData(data, provinsi_select, current_page) {
...
export function renderPagination(total_pages, current_page) {
