// ajax master mahasiswa
import {renderData, renderPagination, buildUrl} from './dev_module.js';
export function fetchDataAndRender(page, keyword_filter = "", gender_filter = "", image_filter = "", provinsi_filter = "", kabupaten_filter = "", kecamatan_filter = "", desa_filter = "", matkul_filter = "") {
    $.ajax({
        url: buildUrl(page, keyword_filter, gender_filter, image_filter, provinsi_filter, kabupaten_filter, kecamatan_filter, desa_filter, matkul_filter),
        type: "GET",
        dataType: "json",
        success: function (response) {
            renderData(response.data, response.dataProvinsi, page);
...
export function loadSelectOptions(url, target_select) {
    $.ajax({
        url: url,
        type: "GET",
        dataType: "json",
