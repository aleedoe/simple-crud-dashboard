// test ajax master_kabupaten

var KabupatenModule = (function() {

    function load() {
        buildStructure();
        KabupatenRequest.fetchDataAndRender(1);
        console.log('kabupaten module loaded');
    }

    function buildStructure() {
        $(".head-name-title-dev").removeClass("d-none");
        $(".head-name-title-dev h1").text("Tabel Kabupaten");
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="KabupatenRequest.dataAdd()"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"> <i
                                class="nav-icon fas fa-times mr-1"></i> Close</button>
                        <button type="button" class="btn btn-primary" onclick="KabupatenRequest.dataEdit()"
                        ...
                        <h5 class="card-title m-0">
                            <div class="d-flex flex-wrap align-items-center">
                                <button type="button" class="btn btn-primary btn-sm mr-2 mt-2"
                                    data-toggle="modal" data-target="#staticBackdrop-add" onclick="KabupatenModule.resetModalAdd()">
    ...
    function buildUrl(page) {
        let url = `script/master_kabupaten/php/get_data.php?page=${page}`;
        return url;
    }
    ...
    function renderData(data, provinsi_select, current_page) {
        ...
        data.forEach(function (row, index) {
            ...
            new_row.innerHTML = `
                ...
                <button type="button" class="btn btn-secondary btn-sm bg-primary border-0" onclick="KabupatenModule.showModalDelete(${row.id})" data-placement="top" title="hapus">
                <i class="nav-icon fas fa-trash fa-sm"></i>
                </button>
        
                <button type="button" class="btn btn-secondary btn-sm ml-sm-1 bg-primary border-0" onclick="KabupatenRequest.loadDataEdit(${row.id})" data-toggle="modal" data-target="#staticBackdrop-edit" data-placement="top" title="edit">
    ...
    function renderPagination(total_pages, current_page) {
        ...
        for (let i = 1; i <= total_pages; i++) {
            ...
            link.addEventListener("click", function () {
                ...
                KabupatenRequest.fetchDataAndRender(i);
            });
        }
        ...
        prevLink.addEventListener("click", function () {
            if (current_page > 1) {
                ...
                KabupatenRequest.fetchDataAndRender(current_page - 1);
            }
        });
    ...
    function showModalDelete(id) {
        $("#button-delete").attr("onclick", "KabupatenRequest.dataDelete(" + id + ")");
